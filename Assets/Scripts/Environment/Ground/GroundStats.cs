...
public class GroundStats : ScriptableObject
{
    ...
    [Tooltip("Min and Max values for growth overall")]
    [SerializeField]
    Vector2 maxGrowthRange;
    ...
    /// <summary>
    /// Minimum Growth Value for ground
    /// </summary>
    /// <value></value>
    public float MinGrowth
    {
        get
        {
            return maxGrowthRange.x;
        }
    }

    /// <summary>
    /// Maximum Growth Value for ground
    /// </summary>
    /// <value></value>
